...
public static function category_post($_args){
	/*	=Params
	------------------------------------------------------------------------------*//*
		$args	=	array(
		'category' => 'pictures',
	...
	while(($spos = strpos($content,$pattern,++$epos)) > -1):
		...
		if($epos != -1):
			...
			echo "<pre>";print_r ($params); echo "</pre>";
					$ret.=FlexoPostManager::category_post($params);
			//	echo "<pre>";print_r ($params); echo "</pre>";
...
public static function flexo_post_option() {
	...
	<form method="POST">
				...
				</br>number of publications <input  type="text" name="count" value="<?php echo $count; ?>"  /> 							 						
				</br>largest title<input  type="text" name="h_num" value="<?php echo $h_num; ?>"  /> 
				</br>height picture<input  type="text" name="height" value="<?php echo $height; ?>"  /> 
				</br>width of the picture<input  type="text" name="width" value="<?php echo $width; ?>"  /> 
				</br>function for display<input  type="text" name="tfunc" value="<?php echo $tfunc; ?>"  /> 			 										 						
...
public static function flexo_post_menu () {
		add_options_page('admin post','post manager option','manage_options','post-manager','FlexoPostManager::flexo_post_option','');
	}


} //class FlexoPostManager
	add_action('admin_menu', 'FlexoPostManager::flexo_post_menu');
