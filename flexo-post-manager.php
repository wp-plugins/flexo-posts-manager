...
public static function flexo_post_option() {
	...
	<form method="POST">
				...
				</br>Category Name	<input  type="text" name="cat_name" value="<?php echo $cat_name; ?>"  /> 
				</br>number of publications <input  type="text" name="br" value="<?php echo $br; ?>"  /> 							 						
				</br>largest title<input  type="text" name="h" value="<?php echo $h; ?>"  /> 
